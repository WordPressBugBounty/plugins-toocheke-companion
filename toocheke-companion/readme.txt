...
= 2.22 =
* UPDATE: Changed the positioning of the Chapter list on the Manga Volume page.
...
= 2.11 =
* NEW: Added `[toocheke-all-manga-volumes]` and `[toocheke-all-manga-chapters]` shortcodes, so you can display a grid of manga volumes or chapters anywhere on your site, with optional filtering by series (and by volume, for chapters).
* UPDATE: General security and code-quality improvements throughout the plugin — safer handling of displayed content, more consistent data validation on saved settings, and translation-readiness cleanup.
...
* NEW: Added placeholders for Bluesky post.
...
* NEW: Added shortcodes to display first and latest Manga Series:
  * [toocheke-first-manga-series]
  * [toocheke-latest-manga-series]
* NEW: Added shortcodes to display first and latest Manga Volume:
  * [toocheke-first-manga-volume]
  * [toocheke-latest-manga-volume]
* FIX: Resolved layout issues affecting the Manga Series grid display.

= 1.200 =
* UPDATE: Added infinite scroll support for manga series.
...
= 1.197 =
* NEW: Image protection for comic posts (prevents direct access and hotlinking). Enable via Toocheke → Options → Images.
