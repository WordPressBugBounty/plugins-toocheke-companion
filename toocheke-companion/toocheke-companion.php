...
if (! defined('TOOCHEKE_COMPANION_VERSION')) {
    define('TOOCHEKE_COMPANION_VERSION', '2.18');
}
...
class Toocheke_Companion_Comic_Features
{
    ...
    public function init()
    {
        ...
        add_filter('pre_get_posts', [$this, 'toocheke_companion_year_archive_order']);
        ...
        add_action('wp_enqueue_scripts', [$this, 'toocheke_universal_set_continue_reading']);
        ...
        // Custom permalink slugs (Toocheke > Options > Navigation > Permalinks)
