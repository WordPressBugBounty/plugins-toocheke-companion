...
class Toocheke_Companion_Comic_Features
{
    ...
    public function init()
    {
        ...
        //RSS
        add_filter('request', array($this, 'toocheke_feed_request'));
        add_filter('pre_get_posts', array($this, 'toocheke_feed_post_status'));
        add_filter('the_excerpt_rss', array($this, 'toocheke_add_metadata_to_rss'));
        add_filter('the_content_feed', array($this, 'toocheke_add_metadata_to_rss'));
...
//Option for determining whether to display infinite scroll of comics on the home page.
                ...
                add_settings_field("toocheke-scroll-past-header", "Do you want readers to scroll past the header when navigating through the comics?", array($this, 'toocheke_scroll_past_header_checkbox'), "toocheke-options-page", "toocheke_comic_navigation_options_section");
            ...
            case 'rss_options':
                ...
                add_settings_section("toocheke_comics_to_main_rss_section", "Add comic posts to main feed?", array($this, 'toocheke_rss_message'), "toocheke-options-page");
                add_settings_field("toocheke-comics-to-main-rss", "Do you want to add comic posts to the main feed?", array($this, 'toocheke_comics_to_main_rss_checkbox'), "toocheke-options-page", "toocheke_comics_to_main_rss_section");
...
//This function adds the WYSIWYG Editor
        wp_editor(
            ...
            array("media_buttons" => true, 'wpautop' => true)
        );
