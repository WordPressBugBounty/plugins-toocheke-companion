 ...
 */
    ...
    if (! defined('TOOCHEKE_COMPANION_VERSION')) {
        define('TOOCHEKE_COMPANION_VERSION', '1.181');
    }
...
<?php }
        ...
        {
            add_meta_box('series-hero-metabox', __('Series Hero Image(Desktop)', 'toocheke-companion'), [$this,
    ...
    value="' . esc_attr($image_id) . '" />';
        ...
        {
            add_meta_box('series-mobile-hero-metabox', __('Series Hero Image(Mobile)', 'toocheke-companion'), [$this,
...
value="' . esc_attr($image_id) . '" />';
    ...
    data-uploader_button_text="' . esc_attr__('Set series hero image', 'toocheke-companion') . '">' .
        ...
        {
            add_meta_box('series-bg-image-metabox', __('Series Background Image', 'toocheke-companion'), [$this,
    ...
    value="' . esc_attr($image_id) . '" />';
        ...
        {
            add_meta_box('series-bg-color-metabox', esc_html__('Series Background Color', 'toocheke-companion'), [$this,
